...
import * as import31 from '../../../../src/app-components/app/app.resolver';
import * as import32 from '../../../../src/app-components/services/utility.service';
import * as import33 from '../../../../src/app-components/services/authentication.service';
import * as import34 from '../../../../src/app-components/services/data.service';
import * as import35 from '../../../../src/app-components/services/route-protection.service';
import * as import36 from '@angular/core/src/di/injector';
import * as import37 from '../login/login.component.ngfactory';
import * as import38 from '../ticket/ticket.component.ngfactory';
import * as import39 from '../home/home.component.ngfactory';
import * as import40 from '../subscriber/subscriber.component.ngfactory';
import * as import41 from '../about/about.component.ngfactory';
import * as import42 from '../404/notfound404.component.ngfactory';
...
import * as import51 from '../../../../src/app-components/login/login.component';
import * as import52 from '../../../../src/app-components/ticket/ticket.component';
import * as import53 from '../../../../src/app-components/home/home.component';
import * as import54 from '../../../../src/app-components/subscriber/subscriber.component';
import * as import55 from '../../../../src/app-components/about/about.component';
import * as import56 from '../../../../src/app-components/404/notfound404.component';
...
class AppModuleInjector extends import0.NgModuleInjector<import1.AppModule> {
  ...
  __DataResolver_51:import31.DataResolver;
  __Logging_52:import32.Logging;
  __UtilityService_53:import32.UtilityService;
  __Authentication_54:import33.Authentication;
  __DataService_55:import34.DataService;
  __RouteProtection_56:import35.RouteProtection;
  __TRANSLATIONS_FORMAT_57:any;
  constructor(parent:import36.Injector) {
    super(parent,[
      ...
      import37.LoginComponentNgFactory,
      import41.AboutComponentNgFactory,
      import42.NotFound404ComponentNgFactory,
      import42.NotFound404ComponentNgFactory,
  ...
  get _LOCALE_ID_15():any {
    if ((this.__LOCALE_ID_15 == (null as any))) { (this.__LOCALE_ID_15 = (null as any)); }
  ...
  get _EventManager_22():import16.EventManager {
    if ((this.__EventManager_22 == (null as any))) { (this.__EventManager_22 = new import16.EventManager(this._EVENT_MANAGER_PLUGINS_21,this.parent.get(import47.NgZone))); }
  ...
  get _LocationStrategy_42():any {
    if ((this.__LocationStrategy_42 == (null as any))) { (this.__LocationStrategy_42 = import8.provideLocationStrategy(this.parent.get(import49.PlatformLocation),this.parent.get(import50.APP_BASE_HREF,(null as any)),this._ROUTER_CONFIGURATION_41)); }
  ...
  get _APP_BOOTSTRAP_LISTENER_50():any[] {
    if ((this.__APP_BOOTSTRAP_LISTENER_50 == (null as any))) { (this.__APP_BOOTSTRAP_LISTENER_50 = [import8.initialRouterNavigation(this._Router_48,this._ROUTER_CONFIGURATION_41)]); }
    return this.__APP_BOOTSTRAP_LISTENER_50;
  }
  get _DataResolver_51():import31.DataResolver {
    if ((this.__DataResolver_51 == (null as any))) { (this.__DataResolver_51 = new import31.DataResolver()); }
    return this.__DataResolver_51;
  }
  get _Logging_52():import32.Logging {
    if ((this.__Logging_52 == (null as any))) { (this.__Logging_52 = new import32.Logging()); }
    return this.__Logging_52;
  }
  get _UtilityService_53():import32.UtilityService {
    if ((this.__UtilityService_53 == (null as any))) { (this.__UtilityService_53 = new import32.UtilityService(this._Router_48)); }
    return this.__UtilityService_53;
  }
  get _Authentication_54():import33.Authentication {
    if ((this.__Authentication_54 == (null as any))) { (this.__Authentication_54 = new import33.Authentication(this._AppState_13,this._Router_48,this._Http_40,this._UtilityService_53)); }
    return this.__Authentication_54;
  }
  get _DataService_55():import34.DataService {
    if ((this.__DataService_55 == (null as any))) { (this.__DataService_55 = new import34.DataService(this._Http_40)); }
    return this.__DataService_55;
  }
  get _RouteProtection_56():import35.RouteProtection {
    if ((this.__RouteProtection_56 == (null as any))) { (this.__RouteProtection_56 = new import35.RouteProtection(this._AppState_13,this._UtilityService_53,this._Location_43,this._Authentication_54)); }
    return this.__RouteProtection_56;
  }
  get _TRANSLATIONS_FORMAT_57():any {
    if ((this.__TRANSLATIONS_FORMAT_57 == (null as any))) { (this.__TRANSLATIONS_FORMAT_57 = (null as any)); }
  ...
  createInternal():import1.AppModule {
    ...
    this._Testability_10 = new import10.Testability(this.parent.get(import47.NgZone));
    this._ApplicationRef__11 = new import11.ApplicationRef_(this.parent.get(import47.NgZone),this.parent.get(import58.Console),this,this._ErrorHandler_8,this,this._ApplicationInitStatus_9,this.parent.get(import10.TestabilityRegistry,(null as any)),this._Testability_10);
  ...
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import59.ErrorHandler)) { return this._ErrorHandler_8; }
    ...
    if ((token === import60.LOCALE_ID)) { return this._LOCALE_ID_15; }
    ...
    if ((token === import61.DOCUMENT)) { return this._DOCUMENT_19; }
    ...
    if ((token === import62.AnimationDriver)) { return this._AnimationDriver_24; }
    if ((token === import18.DomRootRenderer)) { return this._DomRootRenderer_25; }
    if ((token === import63.RootRenderer)) { return this._RootRenderer_26; }
    if ((token === import19.DomSanitizer)) { return this._DomSanitizer_27; }
    if ((token === import64.Sanitizer)) { return this._Sanitizer_28; }
    if ((token === import20.ViewUtils)) { return this._ViewUtils_29; }
    if ((token === import65.IterableDiffers)) { return this._IterableDiffers_30; }
    if ((token === import66.KeyValueDiffers)) { return this._KeyValueDiffers_31; }
    ...
    if ((token === import69.NgModuleFactoryLoader)) { return this._NgModuleFactoryLoader_46; }
    if ((token === import70.ROUTES)) { return this._ROUTES_47; }
    if ((token === import57.Router)) { return this._Router_48; }
    if ((token === import71.ActivatedRoute)) { return this._ActivatedRoute_49; }
    if ((token === import44.APP_BOOTSTRAP_LISTENER)) { return this._APP_BOOTSTRAP_LISTENER_50; }
    if ((token === import31.DataResolver)) { return this._DataResolver_51; }
    if ((token === import32.Logging)) { return this._Logging_52; }
    if ((token === import32.UtilityService)) { return this._UtilityService_53; }
    if ((token === import33.Authentication)) { return this._Authentication_54; }
    if ((token === import34.DataService)) { return this._DataService_55; }
    if ((token === import35.RouteProtection)) { return this._RouteProtection_56; }
    if ((token === import72.TRANSLATIONS_FORMAT)) { return this._TRANSLATIONS_FORMAT_57; }
