...
export function viewFactory_CKEditor0(viewUtils:import2.ViewUtils,parentInjector:import7.Injector,declarationEl:import6.AppElement):import3.AppView<import0.CKEditor> {
  if ((renderType_CKEditor === (null as any))) { (renderType_CKEditor = viewUtils.createRenderComponentType('C:/Source/GitHub/angular2-aot-webpack2-typescript-dotnet/master/src/app-components/directives/ckeditor/ckeditor.component.ts class CKEditor - inline template',0,import9.ViewEncapsulation.None,styles_CKEditor,{})); }
