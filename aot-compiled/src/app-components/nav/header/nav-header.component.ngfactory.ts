...
export function viewFactory_NavHeaderComponent0(viewUtils:import5.ViewUtils,parentInjector:import6.Injector,declarationEl:import4.AppElement):import3.AppView<import1.NavHeaderComponent> {
  if ((renderType_NavHeaderComponent === (null as any))) { (renderType_NavHeaderComponent = viewUtils.createRenderComponentType('C:/Development/angular2-webpack2-dotnet-starter/src/app-components/nav/header/nav-header.template.html',0,import10.ViewEncapsulation.None,styles_NavHeaderComponent,{})); }
