...
function viewFactory_NavFooterComponent0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_NavFooterComponent === null)) {
        (renderType_NavFooterComponent = viewUtils.createRenderComponentType('C:/Source/GitHub/angular2-webpack2-dotnet-starter/complete/frontend/src/app-components/nav/footer/nav-footer.template.html', 0, import11.ViewEncapsulation.None, styles_NavFooterComponent, {}));
    }
