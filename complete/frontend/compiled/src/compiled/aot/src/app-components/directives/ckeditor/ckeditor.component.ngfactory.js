...
function viewFactory_CKEditor0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_CKEditor === null)) {
        (renderType_CKEditor = viewUtils.createRenderComponentType('C:/Source/GitHub/angular2-webpack2-dotnet-starter/complete/frontend/src/app-components/directives/ckeditor/ckeditor.component.ts class CKEditor - inline template', 0, import9.ViewEncapsulation.None, styles_CKEditor, {}));
    }
