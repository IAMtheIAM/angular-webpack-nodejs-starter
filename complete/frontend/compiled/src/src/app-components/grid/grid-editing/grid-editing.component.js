 ...
 */
require('./grid-editing.style.scss');
var GridEditingComponent = (function () {
    // TypeScript public modifiers
    function GridEditingComponent(_ngZone, appState, router, http, authService, authHttp) {
    ...
    GridEditingComponent.prototype.ngOnInit = function () {
        if (utility_service_1.Logging.isEnabled.light) {
            console.log('%c Hello \"Grid Editing\" component!', utility_service_1.Logging.normal.lime);
        }
    ...
    GridEditingComponent.prototype.ngAfterViewInit = function () {
    ...
    GridEditingComponent.prototype.loadKendoUIGrid = function () {
        ///
    ...
    GridEditingComponent.decorators = [
    ...
    /** @nocollapse */
    GridEditingComponent.ctorParameters = [
        { type: core_1.NgZone, },
    ...
    return GridEditingComponent;
}());
exports.GridEditingComponent = GridEditingComponent;
//# sourceMappingURL=grid-editing.component.js.map