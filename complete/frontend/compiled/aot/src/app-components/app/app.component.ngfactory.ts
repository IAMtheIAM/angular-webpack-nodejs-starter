...
export function viewFactory_AppComponent0(viewUtils:import3.ViewUtils,parentInjector:import7.Injector,declarationEl:import6.AppElement):import2.AppView<import0.AppComponent> {
  if ((renderType_AppComponent === (null as any))) { (renderType_AppComponent = viewUtils.createRenderComponentType('C:/Development/angular2-webpack2-dotnet-starter/complete/frontend/src/app-components/app/app.template.html',0,import11.ViewEncapsulation.None,styles_AppComponent,{})); }
