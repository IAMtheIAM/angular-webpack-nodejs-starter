...
export function viewFactory_NavFooterComponent0(viewUtils:import5.ViewUtils,parentInjector:import6.Injector,declarationEl:import4.AppElement):import1.AppView<import0.NavFooterComponent> {
  if ((renderType_NavFooterComponent === (null as any))) { (renderType_NavFooterComponent = viewUtils.createRenderComponentType('C:/Source/GitHub/angular2-webpack2-dotnet-starter/complete/frontend/src/app-components/nav/footer/nav-footer.template.html',0,import11.ViewEncapsulation.None,styles_NavFooterComponent,{})); }
