...
class _View_HomeComponent0 extends import1.DebugAppView<import0.HomeComponent> {
  ...
  createInternal(rootSelector:string):import5.AppElement {
    ...
    var disposable_2:Function = this.renderer.listen(this._el_38,'ngSubmit',this.eventHandler(this._handle_ngSubmit_38_0.bind(this)));
    var disposable_3:Function = this.renderer.listen(this._el_38,'submit',this.eventHandler(this._handle_submit_38_1.bind(this)));
    var disposable_4:Function = this.renderer.listen(this._el_38,'reset',this.eventHandler(this._handle_reset_38_2.bind(this)));
    const subscription_0:any = this._NgForm_38_3.context.ngSubmit.subscribe(this.eventHandler(this._handle_ngSubmit_38_0.bind(this)));
    var disposable_5:Function = this.renderer.listen(this._el_43,'input',this.eventHandler(this._handle_input_43_0.bind(this)));
    var disposable_6:Function = this.renderer.listen(this._el_54,'ngModelChange',this.eventHandler(this._handle_ngModelChange_54_0.bind(this)));
    var disposable_7:Function = this.renderer.listen(this._el_54,'input',this.eventHandler(this._handle_input_54_1.bind(this)));
    var disposable_8:Function = this.renderer.listen(this._el_54,'blur',this.eventHandler(this._handle_blur_54_2.bind(this)));
    const subscription_1:any = this._NgModel_54_5.context.update.subscribe(this.eventHandler(this._handle_ngModelChange_54_0.bind(this)));
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    this.debug(12,5,16);
    const currVal_12_0_0:any = this.context.jwt;
    ...
    this.debug(14,6,17);
    const currVal_14_0_0:any = this.context.jwt;
    ...
    this.debug(16,7,17);
    const currVal_16_0_0:any = this.context.jwt;
    ...
    this.debug(30,13,16);
    const currVal_30_0_0:any = this.context.response;
    ...
    this.debug(32,16,16);
    const currVal_32_0_0:any = this.context.response;
    ...
    this.debug(54,36,27);
    const currVal_54_1_0:any = this.context.localState.value;
    ...
    this.detectContentChildrenChanges(throwOnChange);
    this.debug(10,4,16);
    const currVal_89:any = import6.interpolate(1,'Welcome ',this.context.decodedJwt.username,'!');
    ...
    this.debug(43,26,19);
    const currVal_90:any = this.context.localState.value;
    ...
    this.debug(59,42,4);
    const currVal_91:any = import6.interpolate(1,'Progress: ',this.context.progress,'');
  ...
  private _handle_click_23_0($event:any):boolean {
    ...
    this.debug(23,10,69);
    const pd_23_0:any = ((<any>this.context.callAnonymousApi()) !== false);
    return (true && pd_23_0);
  }
  private _handle_click_26_0($event:any):boolean {
    this.markPathToRootAsCheckOnce();
    this.debug(26,11,69);
    const pd_26_0:any = ((<any>this.context.callSecuredApi()) !== false);
    return (true && pd_26_0);
  }
  private _handle_ngSubmit_38_0($event:any):boolean {
    this.markPathToRootAsCheckOnce();
    this.debug(38,22,14);
    const pd_38_0:any = ((<any>this.context.submitState(this.context.localState.value)) !== false);
    return (true && pd_38_0);
  }
  private _handle_submit_38_1($event:any):boolean {
    this.markPathToRootAsCheckOnce();
    this.debug(38,22,8);
    const pd_38_0:any = ((<any>this._NgForm_38_3.context.onSubmit($event)) !== false);
    return (true && pd_38_0);
  }
  private _handle_reset_38_2($event:any):boolean {
    this.markPathToRootAsCheckOnce();
    this.debug(38,22,8);
    const pd_38_0:any = ((<any>this._NgForm_38_3.context.onReset()) !== false);
    return (true && pd_38_0);
  }
  private _handle_input_43_0($event:any):boolean {
    this.markPathToRootAsCheckOnce();
    this.debug(43,27,19);
    const pd_43_0:any = ((<any>(this.context.localState.value = $event.target.value)) !== false);
    return (true && pd_43_0);
  }
  private _handle_ngModelChange_54_0($event:any):boolean {
    this.markPathToRootAsCheckOnce();
    this.debug(54,36,27);
    const pd_54_0:any = ((<any>(this.context.localState.value = $event)) !== false);
    return (true && pd_54_0);
  }
  private _handle_input_54_1($event:any):boolean {
    this.markPathToRootAsCheckOnce();
    this.debug(54,36,8);
    const pd_54_0:any = ((<any>this._DefaultValueAccessor_54_3.context.onChange($event.target.value)) !== false);
    return (true && pd_54_0);
  }
  private _handle_blur_54_2($event:any):boolean {
    this.markPathToRootAsCheckOnce();
    this.debug(54,36,8);
    const pd_54_0:any = ((<any>this._DefaultValueAccessor_54_3.context.onTouched()) !== false);
    return (true && pd_54_0);
  }
  private _handle_click_61_0($event:any):boolean {
    this.markPathToRootAsCheckOnce();
    this.debug(61,43,24);
    const pd_61_0:any = ((<any>this.context.processInsideAngularZone()) !== false);
    return (true && pd_61_0);
  }
  private _handle_click_64_0($event:any):boolean {
    this.markPathToRootAsCheckOnce();
    this.debug(64,44,23);
    const pd_64_0:any = ((<any>this.context.processOutsideAngularZone()) !== false);
    return (true && pd_64_0);
  }
}
...
class _View_HomeComponent1 extends import1.DebugAppView<any> {
  ...
  createInternal(rootSelector:string):import5.AppElement {
    this._el_0 = import6.createRenderElement(this.renderer,(null as any),'h2',import6.EMPTY_INLINE_ARRAY,this.debug(0,5,12));
...
class _View_HomeComponent2 extends import1.DebugAppView<any> {
  ...
  createInternal(rootSelector:string):import5.AppElement {
    this._el_0 = import6.createRenderElement(this.renderer,(null as any),'pre',new import6.InlineArray2(2,'class','jwt'),this.debug(0,6,12));
...
class _View_HomeComponent3 extends import1.DebugAppView<any> {
  ...
  createInternal(rootSelector:string):import5.AppElement {
    this._el_0 = import6.createRenderElement(this.renderer,(null as any),'pre',new import6.InlineArray2(2,'class','jwt'),this.debug(0,7,12));
...
class _View_HomeComponent4 extends import1.DebugAppView<any> {
  ...
  createInternal(rootSelector:string):import5.AppElement {
    this._el_0 = import6.createRenderElement(this.renderer,(null as any),'h2',import6.EMPTY_INLINE_ARRAY,this.debug(0,13,12));
...
class _View_HomeComponent5 extends import1.DebugAppView<any> {
  ...
  createInternal(rootSelector:string):import5.AppElement {
    this._el_0 = import6.createRenderElement(this.renderer,(null as any),'h3',import6.EMPTY_INLINE_ARRAY,this.debug(0,16,12));
