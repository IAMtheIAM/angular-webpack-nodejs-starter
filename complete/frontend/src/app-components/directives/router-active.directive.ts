// import { Attribute, Directive, ElementRef, Input, Optional, Query, QueryList, Renderer } from '@angular/core';
// import { isPresent } from '@angular/core/src/facade/lang';
// import { Instruction, Router, RouterLink } from '@angular/router';
//
// /**
...
export class RouterActive {
   ...
   //
   // constructor(
   //    public router: Router, public element: ElementRef, public renderer: Renderer,
