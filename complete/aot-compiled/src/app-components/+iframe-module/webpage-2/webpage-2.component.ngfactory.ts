...
export function viewFactory_Webpage20(viewUtils:import5.ViewUtils,parentInjector:import6.Injector,declarationEl:import4.AppElement):import1.AppView<import0.Webpage2> {
  if ((renderType_Webpage2 === (null as any))) { (renderType_Webpage2 = viewUtils.createRenderComponentType('C:/Source/GitHub/angular2-webpack2-dotnet-starter/complete/src/app-components/+iframe-module/webpage-2/webpage-2.template.html',0,import12.ViewEncapsulation.None,styles_Webpage2,{})); }
