...
export function viewFactory_Webpage10(viewUtils:import5.ViewUtils,parentInjector:import6.Injector,declarationEl:import4.AppElement):import1.AppView<import0.Webpage1> {
  if ((renderType_Webpage1 === (null as any))) { (renderType_Webpage1 = viewUtils.createRenderComponentType('C:/Source/GitHub/angular2-webpack2-dotnet-starter/complete/src/app-components/+iframe-module/webpage-1/webpage-1.template.html',0,import12.ViewEncapsulation.None,styles_Webpage1,{})); }
