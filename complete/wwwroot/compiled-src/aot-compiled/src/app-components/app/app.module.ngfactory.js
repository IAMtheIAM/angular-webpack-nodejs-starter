...
var import45 = require('../subscriber/subscriber.component.ngfactory');
var import46 = require('../about/about.component.ngfactory');
var import47 = require('../404/notfound404.component.ngfactory');
var import48 = require('./app.component.ngfactory');
var import49 = require('@angular/core/src/application_tokens');
var import50 = require('@angular/platform-browser/src/dom/events/dom_events');
var import51 = require('@angular/platform-browser/src/dom/events/key_events');
var import52 = require('@angular/core/src/zone/ng_zone');
var import53 = require('@angular/platform-browser/src/dom/debug/ng_probe');
var import54 = require('@angular/common/src/location/platform_location');
var import55 = require('@angular/common/src/location/location_strategy');
var import56 = require('../../../../src/app-components/login/login.component');
var import57 = require('../../../../src/app-components/ticket/ticket.component');
var import58 = require('../../../../src/app-components/home/home.component');
var import59 = require('../../../../src/app-components/subscriber/subscriber.component');
var import60 = require('../../../../src/app-components/about/about.component');
var import61 = require('../../../../src/app-components/404/notfound404.component');
var import62 = require('@angular/router/src/router');
var import63 = require('@angular/core/src/console');
var import64 = require('@angular/core/src/error_handler');
...
var AppModuleInjector = (function (_super) {
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_APP_ID_22", {
        get: function () {
            if ((this.__APP_ID_22 == null)) {
                (this.__APP_ID_22 = import49._appIdRandomProviderFactory());
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_EventManager_26", {
        get: function () {
            if ((this.__EventManager_26 == null)) {
                (this.__EventManager_26 = new import20.EventManager(this._EVENT_MANAGER_PLUGINS_25, this.parent.get(import52.NgZone)));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_RootRenderer_30", {
        get: function () {
            if ((this.__RootRenderer_30 == null)) {
                (this.__RootRenderer_30 = import53._createConditionalRootRenderer(this._DomRootRenderer_29, this.parent.get(import53.NgProbeToken, null)));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_LocationStrategy_46", {
        get: function () {
            if ((this.__LocationStrategy_46 == null)) {
                (this.__LocationStrategy_46 = import8.provideLocationStrategy(this.parent.get(import54.PlatformLocation), this.parent.get(import55.APP_BASE_HREF, null), this._ROUTER_CONFIGURATION_45));
            }
    ...
    AppModuleInjector.prototype.createInternal = function () {
        ...
        this._ROUTER_FORROOT_GUARD_6 = import8.provideForRootGuard(this.parent.get(import62.Router, null));
        ...
        this._ApplicationRef__15 = new import15.ApplicationRef_(this.parent.get(import52.NgZone), this.parent.get(import63.Console), this, this._ErrorHandler_12, this, this._ApplicationInitStatus_13, this.parent.get(import14.TestabilityRegistry, null), this._Testability_14);
