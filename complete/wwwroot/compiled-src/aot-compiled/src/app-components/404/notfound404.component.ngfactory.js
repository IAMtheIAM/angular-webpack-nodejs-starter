...
function viewFactory_NotFound404Component0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_NotFound404Component === null)) {
        (renderType_NotFound404Component = viewUtils.createRenderComponentType('C:/Source/GitHub/angular2-webpack2-dotnet-starter/complete/src/app-components/404/NotFound404.template.html', 0, import11.ViewEncapsulation.None, styles_NotFound404Component, {}));
    }
