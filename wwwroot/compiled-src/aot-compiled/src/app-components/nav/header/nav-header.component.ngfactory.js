...
function viewFactory_NavHeaderComponent0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_NavHeaderComponent === null)) {
        (renderType_NavHeaderComponent = viewUtils.createRenderComponentType('C:/Source/Atlas/src/app-components/nav/header/nav-header.template.html', 0, import10.ViewEncapsulation.None, styles_NavHeaderComponent, {}));
    }
